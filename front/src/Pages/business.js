...
export default function Business() {
  ...
  return (
    ...
    <div className='col-md-6 sect'>
     ...
     <hr/>
     <p>Investir en Tunisie, c’est bénéficier de plusieurs avantages :
<ul>
...
<li>une infrastructure fonctionnelle sans cesse en amélioration.</li>
    ...
    <div className='col-md-6' style={{textAlign:"center"}}>
     <img src='images/tunisie.png' height={"450px"} width={"450px"} />
    </div>
  </div>
...
Autres langues : Français, anglais, italien et allemand<br/>

Monnaie : Dinar Tunisien (TND)<br/>

Taux de change moyen : 1 TND = 0.30 Euro = 0.33 USD (Mars 2023)<br/>

Horaire : GMT+1<br/>

Climat : Méditerranéen, 12°C en hiver et 30°C en été (en moyenne)<br/>

Population : 12 millions d’habitants</p>
    </div>
...
<h1>Cadre de vie Agréable</h1>
     <hr/>
      ...
      <p>La Tunisie offre les commodités nécessaires à un confort idéal :</p> <br/>
