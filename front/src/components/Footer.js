      ...
      <div className="row">
        ...
        <div className="col-md-3 col-sm-6">
          <div className="Informa">
            <h3>A propos</h3>
            <ul>
              <li> Bienvenue chez COSERPLUS Accounting Company,   

                          
              </li>
              
              
              <li> ou nous proposons des services comptables complets adaptés                             
              </li>
              <li>aux besoins uniques de nos clients.                          
              </li>
            </ul>
          </div>
        </div>
